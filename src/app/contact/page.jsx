...
import {
  ...
  FaFacebook,
  FaTiktok,
  FaCheckCircle, // Icon ceklis untuk sukses
  FaPaperPlane, // Icon pesawat untuk tombol kirim
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Contoh: "https://formspree.io/f/xeqwoplz"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-travel-pink">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 h-full relative overflow-hidden">
              {/* TAMPILAN SUKSES (Jika Pesan Terkirim) */}
              {isSuccess ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-10 animate-fade-in">
                  ...
                  <p className="text-gray-600 max-w-md mx-auto mb-8">
                    ...
                    segera membalas pesan Anda melalui email/WhatsApp.
                  </p>
                  <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        {/* PENTING: name="name" wajib untuk Formspree */}
                        <input
                          type="text"
                          name="name"
                      ...
                      <div>
                        ...
                        {/* PENTING: name="email" wajib untuk Formspree */}
                        <input
                          type="email"
                          name="email"
                          className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-travel-pink focus:ring-2 focus:ring-travel-pink/20 outline-none transition-all"
